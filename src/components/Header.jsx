        ...
        <header className="header">
                ...
                <div className="header-top-left">
                    ...
                    <div className="right-links">
                        ...
                        <Link to="#" className="link" onClick={toggleSearchModal}>
                            <i className="icon-search"></i> {t("search")}
                        </Link>
            ...
            <div className={`sidebar ${isSidebarOpen ? "open" : ""}`}>
                ...
                <nav className="sidebar-nav">
                    ...
                    <Link to="/dresses-and-kaftans" className="nav-item">{t("clothes")}</Link>
                    <Link to="/dresses-and-kaftans" className="nav-item">{t("newReleases")}</Link>
                </nav>
